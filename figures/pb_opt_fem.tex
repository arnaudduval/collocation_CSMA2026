...
%% Accompanies image file 'pb_opt_fem_v2.pdf' (pdf, eps, ps)
%%
...
\begingroup%
  ...
  \begin{picture}(1,0.24)%
    \put(0,0){\includegraphics[width=\unitlength]{figures/pb_opt_fem.pdf}}%
    \put(0.34736877,0.15257358){\color[rgb]{0,0,0}\makebox(0,0)[b]{\smash{\faThumbsDown~Meshing
}}}%
    %\put(0.40877822,0.21021035){\color[rgb]{0,0,0}\makebox(0,0)[b]{\smash{\Large\faThumbsDown}}}%
    ...
    %
    \put(0.05,0.230){\color[rgb]{0,0,0}\makebox(0,0)[b]{\smash{\Large\textbf{\texttt{FEM framework:}}}}}
    \put(0.05,0.205){\color[rgb]{0,0,0}\makebox(0,0)[t]{\smash{\large\textbf{\texttt{(CAD-based)}}}}}%
  \end{picture}%
\endgroup%
